    ...
    <section id="home" class="hero mx-container" aria-labelledby="hero-title">
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          <mx-button-link [href]="'mailto:' + siteConfig.email" variant="primary">{{ hero.primaryCta }}</mx-button-link>
      ...
      <div class="identity-card" aria-label="Mirix identity placeholder">
...
export class HeroComponent {
  ...
  readonly badges = ['Java', 'Spring Boot', 'Angular', 'Tailwind CSS', 'PostgreSQL', 'Docker'];
}
