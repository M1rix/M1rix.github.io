      ...
      <main class="project-detail-page">
        <section class="project-hero mx-container">
          ...
          <div class="project-actions">
            <a [routerLink]="['/']" fragment="projects">Back</a>
        ...
        <section class="project-cta mx-container">
          ...
          <mx-button-link [href]="siteConfig.emailHref" variant="primary">Start a project</mx-button-link>
        </section>
...
export class ProjectDetailPageComponent implements OnInit {
  ...
  readonly project = computed(() => {
    return projects.find((item) => item.slug === this.slug()) ?? projects[0];
  });
